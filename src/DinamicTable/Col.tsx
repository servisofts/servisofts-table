...
export default class Col<T> extends React.Component<ColPropsType<T>> {
    ...
    render() {
        ...
        return <View style={{ flexDirection: "row", alignItems: "center" }}>
            ...
            >
                <TouchableOpacity onPress={this.showPopup.bind(this)} style={{ width: "100%", flex: 1, justifyContent: "center", alignItems: "flex-end", flexDirection: "row", paddingStart: 2, paddingBottom: 2, }}>
