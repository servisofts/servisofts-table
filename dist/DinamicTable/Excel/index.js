...
var Excel = /** @class */ (function () {
    ...
    Excel.build = function (props) {
        return __awaiter(this, void 0, void 0, function () {
            var dataFiltrada, colors, headers, headersName, dataRows, isTotal, totalRow, sheetData, ws, range, tableRange, encodedr, wb;
            return __generator(this, function (_a) {
                ...
                sheetData.push.apply(sheetData, dataRows);
                if (isTotal) {
                ...
                encodedr = xlsx.utils.encode_range(tableRange);
